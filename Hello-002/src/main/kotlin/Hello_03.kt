...
fun main() {
     ...
     * KT 에서는 객체를 생성할 때 new 키워드를 사용하지 않는다
     *
     * KT Random 은 객체를 생성할 때 seed 값을 매개변수로 필요로 한다
     * seed 는 random 값을 생성할 때 내부적으로 연산에 사용하는 값
     */
    var rnd:Random = Random(System.currentTimeMillis())

    // 난수 생성
    // 0 ~ 99까지 범위에서 한개의 정해지지 않는 수(임의의 수)를 생성한다
